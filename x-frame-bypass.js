customElements.define(
	...
	class extends HTMLIFrameElement {
	  ...
	  render() {
		// console.log('%c CALL render', 'background: black; color: white')
		// console.log('%c this.src value', 'background: blue; color: magenta', this.src)
		this.load(this.src)
		this.src = ''
		this.sandbox =
		  '' + this.sandbox ||
	  ...
	  static get observedAttributes() {
		// console.log('%c CALL observedAttr', 'background: olive; color: white')
		return ['src'];
	  }
	
	  attributeChangedCallback(name, oldValue, newValue) {
		// console.log('%c CALL attributeChanged', 'background: green; color: white')
		return oldValue === newValue ? undefined : this.render()
	  }
